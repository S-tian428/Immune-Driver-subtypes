...
#library(affy)
#读取验证集数据GSE91061
setwd("G:/免疫亚型分型/result7/GSE91061/Riaz_PD-1_CTLA-4")
...
PD1_clinical_result<-PD1_clinical_result[-which(PD1_clinical_result$RES%in%"NE"),]
...
pro_exp<-pro_exp[,PD1_clinical_result$X]
